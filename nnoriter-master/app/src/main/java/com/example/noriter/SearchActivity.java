...
public class SearchActivity extends AppCompatActivity{
    ...
    String serverURL = "http://117.16.43.25/php.php";

    private String[] ads_1item = {"전체,all","서울시,seoul"};
    ...
    protected void onCreate(Bundle bundle){
        ...
        applybutton.setOnClickListener(new View.OnClickListener(){
            ...
            public  void onClick(View v){
                ...
                //검색 SQL문 세팅
                if(ads_1 != null)
                    Parameters += "Addr_city="+ads_1+"&";
                if(ads_2 != null)
                    Parameters += "Addr_country="+ads_2+"&";
                if(ads_3 != null)
                    Parameters += "Addr_district="+ads_3+"&";
                if(cpubrend != 0)
                    Parameters += "CPU_B=" + cpubrend+"&";
                if(gen != 0)
                    Parameters += "CPU_G=" + gen+"&";
                if(core != null)
                    Parameters += "CPU_C=" + core+"&";
                if(ram != 0)
                    Parameters += "RAM=" + ram+"&";
                if(gpu != null)
                    Parameters += "gpu=" + gpu+"&";
                if(printer)
                    Parameters += "Printer=1&";
                if(card)
                    Parameters += "Card=1&";
                if(office)
                    Parameters += "Office=1&";
                if(charger)
                    Parameters += "Charger=1&";
        ...
        search_ListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                ...
                String Pc_GPU = pclist.get(position).getGPU();
